    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Restaurants", x => x.ReservationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Restaurants_ResturantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TabelsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tabels", x => x.TabelsId);
                    table.ForeignKey(
                        name: "FK_Tabels_Restaurants_ResturantId",
                        column: x => x.ResturantId,
                        principalTable: "Restaurants",
                        principalColumn: "ReservationId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_Tabels_TableId",
                        column: x => x.TableId,
                        principalTable: "Tabels",
                        principalColumn: "TabelsId",
                        onDelete: ReferentialAction.Cascade);
                });
